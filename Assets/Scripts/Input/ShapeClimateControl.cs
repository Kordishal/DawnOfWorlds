...
namespace Input
{
    public class ShapeClimateControl : MonoBehaviour
    {
        ...
        private void AddWeatherEffect()
        {
            ...
            {
                _map.selectedTile.weatherEffects.Add(_selectedEffect);
            }
        }
        ...
        private void RemoveWeatherEffect()
        {
            if (_map.selectedTile != null)
            {
                _map.selectedTile.weatherEffects.Remove(_selectedEffect);
            }
        }
        ...
        private void Start()
        {
            ...
            {
                dropdown.options.Add(new Dropdown.OptionData(weatherEffect.name));
            }
